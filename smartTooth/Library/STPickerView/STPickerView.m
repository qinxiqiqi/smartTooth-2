...
- (void)setTitleColor:(UIColor *)titleColor
{
    ...
    [self.buttonRight setTitleColor:[UIColor colorWithHexString:@"#fa4a3d"] forState:UIControlStateNormal];
}
...
- (UIButton *)buttonRight
{
    if (!_buttonRight) {
        ...
        [_buttonRight setTitleColor:[UIColor colorWithHexString:@"#fa4a3d"] forState:UIControlStateNormal];
