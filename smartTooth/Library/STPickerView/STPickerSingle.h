...
- (void)pickerSingle:(STPickerSingle *)pickerSingle selectedTitle:(NSString *)selectedTitle selectId:(NSString *)channelId;
@end
...
//@property (nonatomic,assign) NSInteger coummunityType;
