...
- (void)robotWelcome
{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"https://kefu.easemob.com/v1/Tenants/2155/robots/visitor/greetings/app"];
    ...
    [NSURLConnection sendAsynchronousRequest:requst queue:[NSOperationQueue mainQueue] completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
        ...
        // converID改成自己的IM服务号
        HMessage *message = [[HMessage alloc] initWithConversationID:_converID from:from to:_converID body:bdy];
        message.ext = dicExt;
        message.direction = 1;
...
//        [_conversation insertMessage:message error:&pError];
        [_conversation addMessage:message error:&pError];
